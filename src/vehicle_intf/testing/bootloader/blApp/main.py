...
class btl_ttl_intf(object):
    ...
    def __decode_btl_packet(self, waitingMsg=None):
        ...
        if ack_byte == 1:
            ...
            if length_if_data > 0:
                data_bytes = self.__read_from_serial_until(DataLength=length_if_data, WaitingMsg=waitingMsg)
    ...
    def __btl_cmd_eraseFlash(self, pageIdx:int, pageN:int):
        data = [pageIdx, pageN]
        packet_info = {"PacketType": 1, "Command": 5, "Data": data}  # Write to address
    ...
    def __btl_cmd_flashApp(self):
        ...
        self.__btl_cmd_eraseApplication(30, 60)
    ...
    def __interactive_btl_intf(self):
        ...
        selected_command = int(input("[BTL]> "))
    ...
    def btl_cmd_intf_JumpToAddr(self):
        jumpAddr = int(input("Input flashing address in hex format (e.x 0x08008000): "), base=16)
